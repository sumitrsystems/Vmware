...
#
# vAPI stub file for package com.vmware.nsx.app_discovery.
#---------------------------------------------------------------------------
...
class AppProfiles(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.app_discovery.app_profiles'
    """
...
class Sessions(VapiInterface):
    ...
    """
    Possible value for ``status`` of method :func:`Sessions.list`.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.app_discovery.sessions'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
               start_app_discovery_session_parameters,
               ):
        """
        ...
        return self._invoke('create',
                            {
                            'start_app_discovery_session_parameters': start_app_discovery_session_parameters,
                            })
...
class _AppProfilesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_input_type = type.StructType('operation-input', {
            'app_profile': type.ReferenceType('com.vmware.nsx.model_client', 'AppProfile'),
        })
        create_error_dict = {
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/app-discovery/app-profiles',
            request_body_parameter='app_profile',
            path_variables={
            },
            query_parameters={
            },
        ...
        delete_input_type = type.StructType('operation-input', {
            'app_profile_id': type.StringType(),
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/api/v1/app-discovery/app-profiles/{app-profile-id}',
            path_variables={
        ...
        operations = {
            'create': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'AppProfile'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.app_discovery.app_profiles',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Sessions': Sessions,
        'sessions': 'com.vmware.nsx.app_discovery.sessions_client.StubFactory',
    }
