...
#
# vAPI stub file for package com.vmware.nsx.node.services.mgmt_plane_bus.
#---------------------------------------------------------------------------
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.node.services.mgmt_plane_bus.status'
    """
...
class _StatusStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/api/v1/node/services/mgmt-plane-bus/status',
            path_variables={
            },
            query_parameters={
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.node.services.mgmt_plane_bus.status',
