...
class DiscoverySessions(VapiInterface):
    ...
    def get(self,
        ...
        :type  destination_id: :class:`str` or ``None``
        :param destination_id: Destination element ID (optional)
        :type  source_id: :class:`str` or ``None``
        :param source_id: Source element ID (optional)
...
class _DiscoverySessionsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_input_type = type.StructType('operation-input', {
            ...
            'destination_id': type.OptionalType(type.StringType()),
            'source_id': type.OptionalType(type.StringType()),
