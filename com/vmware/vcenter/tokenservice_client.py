...
class InvalidRequest(Error):
    ...
    :attr:`TokenExchange.ExchangeSpec.grant_type`). **Warning:** This class is
...
class InvalidGrant(Error):
    ...
    authorization request, or was issued to another client. **Warning:** This
...
class TokenExchange(VapiInterface):
    ...
    **Warning:** This class is available as technical preview. It may be
    ...
    """
    Class attribute indicates that token exchange grant type. **Warning:** This
    ...
    """
    Class attribute indicates OAuth 2.0 access token type. **Warning:** This class
    ...
    """
    Class attribute indicates OAuth 2.0 refresh token type. **Warning:** This class
    attribute is available as technical preview. It may be changed in a future
    release.
    ...
    """
    Class attribute indicates OIDC ID token type. **Warning:** This class attribute
    ...
    """
    Class attribute indicates base64-encoded SAML 1.1 token type. **Warning:** This
    class attribute is available as technical preview. It may be changed in a
    future release.
    ...
    """
    Class attribute indicates base64-encoded SAML 2.0 token type. **Warning:** This
    class attribute is available as technical preview. It may be changed in a
    future release.
    ...
    **Warning:** This class attribute is available as technical preview. It may be
    changed in a future release.
    ...
    not applicable in that context. **Warning:** This class attribute is available
    ...
    class ExchangeSpec(VapiStruct):
        ...
        token exchange. **Warning:** This class is available as technical preview.
        ...
        def __init__(self,
            ...
            :param grant_type: The value of :attr:`TokenExchange.TOKEN_EXCHANGE_GRANT` indicates
                that a token exchange is being performed. **Warning:** This
            ...
            :param resource: Indicates the location of the target service or resource where the
                client intends to use the requested security token. **Warning:**
            ...
            :param scope: A list of space-delimited, case-sensitive strings, that allow the
                ...
                used. **Warning:** This attribute is available as technical
            ...
            :param requested_token_type: An identifier for the type of the requested security token. If the
                ...
                :attr:`TokenExchange.ExchangeSpec.audience` parameter. **Warning:**
                This attribute is available as technical preview. It may be changed
                in a future release.
                if can be inferred from other arguments or not needed for specific
                case of exchange.
            ...
            :param subject_token: A security token that represents the identity of the party on
                ...
                is base64-encoded. **Warning:** This attribute is available as
    ...
    class Info(VapiStruct):
        ...
        token exchange response. **Warning:** This class is available as technical
        preview. It may be changed in a future release.
        ...
        def __init__(self,
            ...
            :param access_token: The security token issued by the server in response to the token
                exchange request. Token is base64-encoded. **Warning:** This
                attribute is available as technical preview. It may be changed in a
                future release.
            ...
            :param issued_token_type: An identifier, that indicates the type of the security token in the
                :attr:`TokenExchange.Info.access_token` parameter. **Warning:**
                This attribute is available as technical preview. It may be changed
                in a future release.
            :type  token_type: :class:`str`
            :param token_type: A case-insensitive value specifying the method of using the access
                token issued. **Warning:** This attribute is available as technical
                preview. It may be changed in a future release.
            ...
            :type  scope: :class:`str` or ``None``
            :param scope: Scope of the issued security token. **Warning:** This attribute is
            ...
            :param refresh_token: A refresh token can be issued in cases where the client of the
                ...
                original credential is no longer valid. **Warning:** This attribute
    ...
    def exchange(self,
        ...
        authorization data. **Warning:** This method is available as technical
        preview. It may be changed in a future release.
