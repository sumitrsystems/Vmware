...
class Peerconfig(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vmc.orgs.sddcs.networks.edges.peerconfig'
    """
...
class Status(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vmc.orgs.sddcs.networks.edges.status'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Vnics(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vmc.orgs.sddcs.networks.edges.vnics'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
